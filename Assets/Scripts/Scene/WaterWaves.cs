...
public class WaterWaves : MonoBehaviour
{
    ...
    public float GetHeight(Vector3 position)
    {
        ...
        //weighted sum
        var height = Mesh.vertices[index(p1.x, p1.z)].y
                   + Mesh.vertices[index(p2.x, p2.z)].y
                   + Mesh.vertices[index(p3.x, p3.z)].y
                   + Mesh.vertices[index(p4.x, p4.z)].y;

        height = position.y - height / 4 - 0.1f;
        return height;
